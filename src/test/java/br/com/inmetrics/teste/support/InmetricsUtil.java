...
public class InmetricsUtil {
    ...
    //Mostrar cpf gerado com validação
    public static void main (String args[]){
        System.out.println(geraCPF());
        System.out.println(validaCPF(geraCPF()));
    }

    public static String dataAtualSemFormato(){
        Date date = new Date();
        SimpleDateFormat format = new SimpleDateFormat("dd/MM/yyyy HH:mm:ss");
        String dataAtual = format.format(date).replace("/", "").replace(" ", "").replace(":", "");
        return dataAtual;
    }
